 ...
 *  based on v1 code by James P ('elasticdev')
 *
 *
 *  Revision History
 *  ================
 *  2015-10-09: Version: 2.0.1 -Mr. Lucky
 *  Defined 'event' as empty (vs. "null")
 *
 *  2015-09-10: Version: 2.0.0 -Mr. Lucky
 *  Converted tiles to ST v2 style
 *
 ...
 */
metadata {
    definition (name: "Smart Energy Switch v2", namespace: "HDFLucky", author: "Mr. Lucky") {
	capability "Actuator"
...
multiAttributeTile(name:"switch", type: "lighting", width: 6, height: 4, canChangeIcon: true) {
	...
	tileAttribute ("device.power", key: "SECONDARY_CONTROL") {
    		attributeState "statusText", label:'Current power draw: ${currentValue} W'
	}
}
...
standardTile("reset", "device.energy", decoration: "flat", width: 2, height: 2) {
    state "default", label:' ', action:"reset", icon:'https://dl.dropboxusercontent.com/u/52901840/reset_kWh@2x.png'
}

main (["switch", "energy"])
details(["switch", "power", "refresh", "energy", "reset"])
}
...
input "reportInterval", "number",
	...
	description: "Time interval (in minutes) for sending device reports",
	defaultValue: 1,
	required: false,
	displayDuringSetup: true
...
input "switchAll", "enum",
	...
	description: "How does switch respond to the 'Switch All' command",
 ...
 */
def configure() { //Get the values from the Preferences section
